...
command = "python test.py --img_folder=../" + args.indir + " --gpu_ids=0 --name=model1 --epoch=20"
print(command)
os.system(command)
os.chdir('..')
...
command = f"python 3dface2idr_mat.py --in_root Deep3DFaceRecon_pytorch/checkpoints/model1/results/{out_folder}/epoch_20_000000 --out_path {os.path.join(args.indir, 'crop', 'cameras.json')}"
print(command)
os.system(command)
